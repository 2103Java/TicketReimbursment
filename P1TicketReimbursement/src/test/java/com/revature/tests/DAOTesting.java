...
public class DAOTesting {
	...
	//@Test //Note user_id_seq updates in DB with every test
	...
	public void employeeDaoFindTests() {
		...
		if(e.getUsername().compareTo("employee1") != 0)fail("Failed to find employee1 in DB by ID");
		
		Employee e2 = ed.findEmployee(new Employee("employee2","password",CATEGORY.EMPLOYEE,8),conn);
		if(e2.getUsername().compareTo("employee2") != 0)fail("Failed to find empoyee2 in DB by Employee Object");
